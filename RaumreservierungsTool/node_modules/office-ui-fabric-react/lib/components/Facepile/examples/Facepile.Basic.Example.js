    ...
    FacepileBasicExample.prototype.render = function () {
        ...
        return (React.createElement("div", { className: styles.container },
            ...
            React.createElement("div", { className: styles.control },
                ...
                React.createElement(Checkbox, { className: styles.checkbox, styles: checkboxStyles, label: "Fade In", checked: this.state.imagesFadeIn, onChange: this._onChangeFadeIn }))));
    };

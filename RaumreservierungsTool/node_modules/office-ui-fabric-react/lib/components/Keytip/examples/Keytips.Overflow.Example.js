...
var KeytipsOverflowExample = /** @class */ (function (_super) {
    ...
    KeytipsOverflowExample.prototype.render = function () {
        return (React.createElement("div", null,
            ...
            React.createElement(OverflowSet, { role: "menubar", styles: overflowSetStyles, items: this.state.items, overflowItems: this.state.overflowItems, keytipSequences: keytipMap.OverflowButton4.keySequences, onRenderOverflowButton: this._onRenderOverflowButton, onRenderItem: this._onRenderItem }),
    ...
    KeytipsOverflowExample.prototype._onRenderItem = function (item) {
        return (React.createElement(CommandBarButton, __assign({ role: "menuitem" }, item, { styles: commandBarButtonStyles, menuProps: item.subMenuProps }), item.name));
    };

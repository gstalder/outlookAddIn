...
import { DelayedRender, getId, classNamesFunction, getNativeProps, htmlElementProperties, css, initializeComponentRef, Customizer, } from '../../Utilities';
...
var MessageBarBase = /** @class */ (function (_super) {
    ...
    MessageBarBase.prototype._renderInnerText = function () {
        ...
        var settings = {
            theme: __assign(__assign({}, theme), { semanticColors: __assign(__assign({}, theme.semanticColors), { link: theme.semanticColors.messageLink, linkHovered: theme.semanticColors.messageLinkHovered }) }),
        };
        return (React.createElement(Customizer, { settings: settings },
            React.createElement("div", { className: this._classNames.text, id: this.state.labelId, role: "status", "aria-live": this._getAnnouncementPriority() },

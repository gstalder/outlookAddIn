...
var MessageBarBase = /** @class */ (function (_super) {
    ...
    MessageBarBase.prototype._renderInnerText = function () {
        ...
        var settings = {
            theme: tslib_1.__assign(tslib_1.__assign({}, theme), { semanticColors: tslib_1.__assign(tslib_1.__assign({}, theme.semanticColors), { link: theme.semanticColors.messageLink, linkHovered: theme.semanticColors.messageLinkHovered }) }),
        };
        return (React.createElement(Utilities_1.Customizer, { settings: settings },

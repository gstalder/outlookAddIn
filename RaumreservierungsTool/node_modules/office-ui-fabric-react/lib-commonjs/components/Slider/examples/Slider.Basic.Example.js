...
var SliderBasicExample = /** @class */ (function (_super) {
    ...
    SliderBasicExample.prototype.render = function () {
        ...
        return (React.createElement(Stack_1.Stack, { tokens: stackTokens, styles: stackStyles },
            ...
            React.createElement(Slider_1.Slider, { label: "Snapping slider example", min: 0, max: 50, step: 10, defaultValue: 20, showValue: true, onChange: function (value) { return console.log(value); }, snapToStep: true }),
            ...
            React.createElement(Slider_1.Slider, { label: "Example with formatted value", max: 100, ariaValueText: function (value) { return value + " percent"; }, valueFormat: function (value) { return value + "%"; }, showValue: true }),
